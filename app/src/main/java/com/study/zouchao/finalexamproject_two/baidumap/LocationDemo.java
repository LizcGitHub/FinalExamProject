...
public class LocationDemo extends Activity implements SensorEventListener {
    ...
    private double mCurrentLat = 24.62273;
    private double mCurrentLon = 118.081478;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFab.setOnClickListener(btnClickListener);
...
//            mCurrentLon = location.getLongitude();
            mCurrentLat = 24.62273;
            mCurrentLon = 118.081478;
    ...
    public static void actionStartLocationDemo(Context context) {
