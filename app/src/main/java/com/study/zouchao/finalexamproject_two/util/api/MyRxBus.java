...
public class MyRxBus {
    ...
    public static synchronized MyRxBus $(){
        if (null == instance){
     ...
     * @return
     */
    public MyRxBus OnEvent(Observable<?> mObservable, Action1<Object> mAction1){
    ...
    @SuppressWarnings({"rawtypes"})
    public <T> Observable<T> reregister(@NonNull Object tag){
     ...
     */
    @SuppressWarnings("rawtypes")
    public MyRxBus unregister(@NonNull Object tag,
